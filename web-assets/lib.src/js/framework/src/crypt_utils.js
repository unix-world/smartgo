 ...
 *
 */
smartJ$CryptoCipherTwofish = new class{constructor(){ // STATIC CLASS (ES6)
	'use strict';
 ...
 *
 */
smartJ$CryptoCipherBlowfish = new class{constructor(){ // STATIC CLASS (ES6)
	'use strict';
 ...
 *
 */
smartJ$CipherCrypto = new class{constructor(){ // STATIC CLASS (ES6)
	'use strict';
	 ...
	 */
	const tfEnc = (key, str, isBinary=false) => {
		//--
		const _m$ = 'tfEnc';
		//--
	 ...
	 */
	const bfEnc = (key, str, isBinary=false) => {
		//--
		const _m$ = 'bfEnc';
		//--
		str = pureStr(str); // do not trim
