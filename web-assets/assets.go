...
const(
	VERSION string = "r.20231125.2104"

	LAST_MODIFIED_DATE_TIME string = "2023-10-25 12:07:08" // must be UTC time, (string) assets last modified ; UPDATE THIS AFTER EACH TIME THE ASSETS ARE MODIFIED !
