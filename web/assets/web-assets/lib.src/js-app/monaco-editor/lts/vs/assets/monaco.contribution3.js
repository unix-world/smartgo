define("vs/assets/monaco.contribution3", ["require", "exports", "./editor.api"], (function(require, exports, editor_api) {
	"use strict";
	...
	function getMode() {
		return new Promise((resolve, reject) => require(["./jsonMode"], resolve, reject));
	}
