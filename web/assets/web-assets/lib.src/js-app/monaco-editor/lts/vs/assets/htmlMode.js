define("vs/assets/htmlMode", ["module", "exports", "./workers", "./lspLanguageFeatures", "./editor.api"], (function(module, exports, workers, lspLanguageFeatures, editor_api) {
	"use strict";
			...
			if (!this._client) {
				this._worker = workers.createWebWorker({
					...
					createWorker: () => new Worker(new URL(
						/* @vite-ignore */
						"" + new URL(require.toUrl("./html.worker.js"), document.baseURI).href, // {{{UXM-SYNC-HTML-WORKER-NAME}}}
