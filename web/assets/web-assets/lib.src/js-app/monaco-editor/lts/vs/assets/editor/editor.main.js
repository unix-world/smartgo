...
define("vs/assets/editor/editor.main", ["exports", "require", "../nls.messages-loader!", "../monaco.contribution", "../monaco.contribution2", "../monaco.contribution3", "../monaco.contribution4", "../basic-languages/monaco.contribution", "../editor.api", "../workers"], (function(exports, require, nls_messagesLoader_, language_css_monaco_contribution, language_html_monaco_contribution, language_json_monaco_contribution, language_typescript_monaco_contribution, basicLanguages_monaco_contribution, editor_api, workers) {
	"use strict";
	...
	const __worker_url_0__ = "" + new URL(require.toUrl("../json.worker.js"), document.baseURI).href; 		// {{{UXM-SYNC-JSON-WORKER-NAME}}}
	const __worker_url_1__ = "" + new URL(require.toUrl("../css.worker.js"), document.baseURI).href; 		// {{{UXM-SYNC-CSS-WORKER-NAME}}}
	const __worker_url_2__ = "" + new URL(require.toUrl("../html.worker.js"), document.baseURI).href; 		// {{{UXM-SYNC-HTML-WORKER-NAME}}}
	const __worker_url_3__ = "" + new URL(require.toUrl("../ts.worker.js"), document.baseURI).href; 		// {{{UXM-SYNC-TS-WORKER-NAME}}}
	const __worker_url_4__ = "" + new URL(require.toUrl("../editor.worker.js"), document.baseURI).href; 	// no sync, there are no other occurences
...
\`\`\``,
	...
	const styleSheetUrl = require__namespace.toUrl("./editor.main.css");
