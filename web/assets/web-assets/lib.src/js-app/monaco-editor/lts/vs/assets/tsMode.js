define("vs/assets/tsMode", ["module", "exports", "./editor.api", "./workers", "./monaco.contribution4"], (function(module, exports, editor_api, workers, language_typescript_monaco_contribution) {
	"use strict";
	class WorkerManager {
				...
				this._client = (async () => {
					this._worker = workers.createWebWorker({
						...
						createWorker: () => new Worker(new URL(
							/* @vite-ignore */
							"" + new URL(require.toUrl("./ts.worker.js"), document.baseURI).href, // {{{UXM-SYNC-TS-WORKER-NAME}}}
