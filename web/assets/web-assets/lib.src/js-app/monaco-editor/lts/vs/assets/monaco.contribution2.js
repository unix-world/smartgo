define("vs/assets/monaco.contribution2", ["require", "exports", "./editor.api"], (function(require, exports, editor_api) {
	"use strict";
	...
	function getMode() {
		return new Promise((resolve, reject) => require(["./htmlMode"], resolve, reject));
	}
