define("vs/assets/cssMode", ["module", "exports", "./workers", "./lspLanguageFeatures", "./editor.api"], (function(module, exports, workers, lspLanguageFeatures, editor_api) {
	"use strict";
			...
			if (!this._client) {
				this._worker = workers.createWebWorker({
					...
					createWorker: () => new Worker(new URL(
						/* @vite-ignore */
						"" + new URL(require.toUrl("./css.worker.js"), document.baseURI).href, // {{{UXM-SYNC-CSS-WORKER-NAME}}}
