...
//--------
// FORMATTERS & EDITORS for SlickGrid v1.4.3.2.smart.20260902
//
	...
	const SlickEditor = {
		...
		LongTextCellEditor : function (args) {
			...
			this.init = function() {
				...
				$('<div style="text-align:right"><button class="ux-button ux-button-xsmall">Cancel</button><button class="ux-button ux-button-xsmall ux-button-alt">Save</button></div>')
					.appendTo($wrapper);
