...
// (c) 2019-2023 unix-world.org
// License: MIT
// v.20230505
//== unixman changes:
// (#1) change some default options as: force_text: true ; multiple: false
// (#2) several small fixes on get_json options
// (#3) jQuery 3.5.0 ready (fixed XHTML Tags)
// (#4) check jQuery instance instead of $
//==
...
/*jshint -W083 */
	...
	$.jstree.defaults.core = {
		 ...
		 */
		multiple		: false, // unixman: default was: true
		/**
		 ...
		 */
		force_text : true, // unixman: default was: false
		/**
	...
	$.jstree.core.prototype = {
		...
		get_node : function (obj, as_dom) {
			...
			if (obj instanceof jQuery && obj.length && obj[0].id) { // unixman
				obj = obj[0].id;
			}
			var dom;
			try {
		 ...
		 * @param  {Boolean} options.no_icon do not include icon attribute (unixman)
