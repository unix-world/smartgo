...
const(
	VERSION string = "r.20251229.2358"

	LAST_MODIFIED_DATE_TIME string = "2025-12-28 17:58:08" // must be UTC time, (string) assets last modified ; UPDATE THIS AFTER EACH TIME THE ASSETS ARE MODIFIED !
