...
import (
	...
	"github.com/unix-world/smartgo/markup/markdown/parser"
)
...
type RendererOptions struct {
	...
	// Defaults (note content quote is not closed) to `  <meta name="GENERATOR" content="github.com/unix-world/smartgo/markup/markdown markdown processor for Go`
	Generator string
}
