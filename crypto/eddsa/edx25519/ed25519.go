...
type SignerOptions struct {
	// Hash must be crypto.Hash(0) for Ed25519/Ed25519ctx, or crypto.SHA3-512 (replaced from crypto.SHA512)
	// for Ed25519ph.
	crypto.Hash
...
// opts.
// The opts.HashFunc() must return SHA3-512 (replaced from SHA512) to specify the Ed25519Ph variant.
