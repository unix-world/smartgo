// Package edx25519 implements Edx25519 signature scheme as described in RFC-8032.
// Compared with Ed25519, the Edx25519 uses SHA3-512 instead of SHA512.
...
//
// Signing with Edx25519Ph or Edx25519Ctx requires a context string for domain
// separation. This parameter is passed using a SignerOptions struct defined
// in this package. While Edx25519Ph accepts an empty context, Edx25519Ctx
...
// modified by unixman r.20260216: use sha3-512 instead of sha512
...
// that are specific to the Edx25519 signature schemes.
type SignerOptions struct {
	// Hash must be crypto.Hash(0) for Edx25519/Edx25519ctx, or crypto.SHA3-512 (replaced from crypto.SHA512)
	// for Edx25519ph.
	crypto.Hash

	// Context is an optional domain separation string for Edx25519ph and a
	// must for Edx25519ctx. Its length must be less or equal than 255 bytes.
	Context string
...
// PrivateKey is the type of Edx25519 private keys. It implements crypto.Signer.
...
// This function is derived from crypto.ed25519 and is similar with the
// three signature variants defined in RFC-8032, namely Ed25519 (or pure
// EdDSA), Ed25519Ph, and Ed25519Ctx.
// The opts.HashFunc() must return zero to specify either Edx25519 or Edx25519Ctx
// variant. This can be achieved by passing crypto.Hash(0) as the value for
// opts.
// The opts.HashFunc() must return SHA3-512 (replaced from SHA512) to specify the Edx25519Ph variant.
// This can be achieved by passing crypto.SHA3-512 (replaced from crypto.SHA512) as the value for opts.
...
//	H := sha512.New()
	...
	// 1.  Hash the 32-byte private key using SHA3-512 (replaced from SHA-512).
	...
	// 4.  Compute SHA3-512(dom2(F, C) || R || A || PH(M)) (replaced from SHA512(dom2(F, C) || R || A || PH(M))).
	H.Reset()
...
// This function supports the signature variant defined in RFC-8032: Edx25519,
...
// This function supports the signature variant defined in RFC-8032: Edx25519ph,
// meaning it internally hashes the message using SHA3-512 (replaced from SHA-512), and optionally
...
// This function supports the signature variant defined in RFC-8032: Edx25519ctx,
...
// The opts.HashFunc() must return SHA512 to specify the Edx25519Ph variant.
...
// signature, or when the public key cannot be decoded.
// This function supports the signature variant: Edx25519,
// also known as the pure version of EdDSA.
...
// signature, or when the public key cannot be decoded.
// This function supports the signature variant: Edx25519ph,
...
// not provided.
// This function supports the signature variant: Edx25519ctx,
