...
See [godoc](https://godoc.org/github.com/unix-world/webview).
...
Download [webview.h](https://raw.githubusercontent.com/unix-world/webview/master/webview.h) and include it in your C/C++ code:
...
Also, there is a more more advanced complete C++ app, [Slide](https://github.com/unix-world/slide), that uses webview as a GUI. You may have a look how webview apps can be built, packages and how automatic CI/CD can be set up.
