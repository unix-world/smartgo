...
func MatchLimitNoCase(str, pattern string, maxcomp int) (matched, stopped bool) {
	return matchLimit0(str, pattern, maxcomp, true)
}

func matchLimit0(str, pattern string, maxcomp int, nocase bool) (matched, stopped bool) {
	if pattern == "*" {
		return true, false
	}
	counter := 0
...
func match(str, pat string, slen int, counter *int, maxcomp int, nocase bool) result {
