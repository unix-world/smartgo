...
import (
	...
	"github.com/unix-world/smartgo/db/eliasdb/pkg/krotik/common/termutil/getch"
)
...
func (ht *historyLineTerminalMixin) NextLine() (string, error) {
	...
	if ht.histFile != "" {
		os.WriteFile(ht.histFile, []byte(ht.history.String()), smart.CHMOD_FILES) // unixman use os instead of io-util
	}
