...
import (
	...
	"github.com/unix-world/smartgo/db/eliasdb/pkg/krotik/ecal/cli/tool"
	ecalconfig "github.com/unix-world/smartgo/db/eliasdb/pkg/krotik/ecal/config"
	...
	"github.com/unix-world/smartgo/db/eliasdb/ecal/dbfunc"
...
func (si *ScriptingInterpreter) Run() error {
	...
	if ok, _ := fileutil.PathExists(si.EntryFile); !ok {
		err = os.WriteFile(si.EntryFile, []byte(dummyEntryFile), smart.CHMOD_FILES) // unixman use os instead of io-util
	}
