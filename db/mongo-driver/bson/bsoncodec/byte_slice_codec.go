...
// configuration methods on a [github.com/unix-world/smartgo/db/mongo-driver/bson.Encoder] or
// [github.com/unix-world/smartgo/db/mongo-driver/bson.Decoder]. To configure the byte slice
