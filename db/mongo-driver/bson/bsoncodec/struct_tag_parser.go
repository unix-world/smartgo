...
//
// Deprecated: Use [github.com/unix-world/smartgo/db/mongo-driver/bson.Encoder.UseJSONStructTags] and
// [github.com/unix-world/smartgo/db/mongo-driver/bson.Decoder.UseJSONStructTags] instead.
