...
import (
	...
	"github.com/unix-world/smartgo/db/mongo-driver/bson/bsonoptions"
...
// the configuration methods on a [github.com/unix-world/smartgo/db/mongo-driver/bson.Encoder] or
// [github.com/unix-world/smartgo/db/mongo-driver/bson.Decoder]. To configure the empty interface
// encode and decode behavior for a mongo.Client, use
// [github.com/unix-world/smartgo/db/mongo-driver/mongo/options.ClientOptions.SetBSONOptions].
//
