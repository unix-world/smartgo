...
import (
	...
	"github.com/unix-world/smartgo/crypto/pkcs8"
	...
	"github.com/unix-world/smartgo/db/mongo-driver/tag"
	...
	"github.com/unix-world/smartgo/db/mongo-driver/x/mongo/driver/connstring"
...
//
// AuthMechanism: the mechanism to use for authentication. Supported values include "MONGODB-CR", "PLAIN", "GSSAPI", 
// "MONGODB-X509", and "MONGODB-AWS". This can also be set through the "authMechanism"
