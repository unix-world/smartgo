...
// go build -ldflags="-X 'github.com/unix-world/smartgo/db/sqlite3.driverName=my-sqlite3'"
...
//
// sqlite3 adds the following query parameters to those used by SQLite:
//   _loc=XXX
